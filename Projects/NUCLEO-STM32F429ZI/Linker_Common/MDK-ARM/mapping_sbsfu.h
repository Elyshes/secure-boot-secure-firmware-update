...
#define SE_REGION_RAM_STACK_TOP 0x20001000
#define SE_REGION_RAM_END 0x20002FFF

/* SBSFU RAM1 region */
#define SB_REGION_RAM_START (SE_REGION_RAM_END + 0x1)
#define SB_REGION_RAM_END 0x2002CFEF

/* Shared RAM for Image State Handling */
#define SB_FWIMG_STATE_REGION_RAM_START (SB_REGION_RAM_END + 1)
#define SB_FWIMG_STATE_REGION_RAM_END 0x2002CFFF
