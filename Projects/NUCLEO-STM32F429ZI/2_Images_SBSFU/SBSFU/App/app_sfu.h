...
/* TODO: comment out "#define SECBOOT_DISABLE_SECURITY_IPS" before testing security IPs/development end */
...
/* TODO: uncomment "#define SFU_FINAL_SECURE_LOCK_ENABLE" after finishing testing and development */
